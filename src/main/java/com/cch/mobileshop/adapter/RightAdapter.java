...
public class RightAdapter extends RecyclerView.Adapter <RightAdapter.RightHoder>{
    ...
    private final ArrayList<Right_layout_reponse.DataBean> datas;

    public RightAdapter(Context context, ArrayList<Right_layout_reponse> rightDatas) {
    ...
    public RightHoder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.rigtt_layout_activity, viewGroup, false);
        return new RightHoder(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull RightHoder rightHoder, int i) {
        Right_layout_reponse.DataBean dataBean = datas.get(i);
    ...
    public class RightHoder extends RecyclerView.ViewHolder{
        ...
        @BindView(R.id.tv_icon)ImageView iv_icon;
